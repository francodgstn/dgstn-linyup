...
variable "api_site_id" {
  type        = string
  description = "Hosting site ID for the public API + MCP server (custom domain api-stg.linyup.com)."
  default     = "linyup-api-staging"
}

variable "help_site_id" {
  type        = string
  description = "Hosting site ID for the public product docs, apps/help (custom domain docs-stg.linyup.com)."
