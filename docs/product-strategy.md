...
* ❌ Horizontal/statutory accounting suite — AR/AP & invoicing, VAT filing,
  ...
  purchase and posts nothing — not invoicing. The `qr-invoices` plugin is the
  one recorded exception: issue a QR-bill invoice and mark it paid, nothing
  more — no reminders, dunning or bank reconciliation.) ✅ In scope
