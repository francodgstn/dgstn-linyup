...
When you load linyup.com, our hosting provider automatically processes technical data needed to deliver the site securely: IP address, browser and device type, referring page, and date and time of access. This is necessary to operate and secure the site.

*Legal basis:* legitimate interest (GDPR Art. 6(1)(f)) / FADP Art. 31.

**b) When you contact us or join a waitlist**

If you fill in a contact or sign-up form, we process the data you provide, such as your name, email address, studio name, and message.

*Purpose:* to respond to you and, where you ask for it, to keep you informed about Linyup.
...
If you opt in, we may send you product news through our email provider. You can unsubscribe at any time using the link in each email.
...
To exercise any of these, email hello@linyup.com. You also have the right to lodge a complaint:
