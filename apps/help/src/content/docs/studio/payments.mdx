...
<Flow
  label="Where the money goes: from the member, through your Stripe account, to your bank"
  arrows={['pays', 'Stripe pays out']}
  steps={[
    { title: 'Your member', text: 'Pays at checkout, or automatically when a membership renews.' },
    { title: 'Your Stripe account', text: "The payment lands here. Linyup's fee and Stripe's fee are taken off.", accent: true },
    { title: 'Your bank', text: 'Stripe pays out the rest, on the schedule set in your Stripe account.' },
  ]}
/>
...
- **Memberships** that renew weekly, every two weeks, monthly, quarterly or yearly, and one-off plans such as class packs. See [Offerings](/studio/offerings/).
