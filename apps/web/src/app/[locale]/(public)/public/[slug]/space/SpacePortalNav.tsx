        ...
        {items.map((it) => {
          ...
          return (
            <Link
              ...
              className="flex-1 inline-flex min-w-0 flex-col items-center justify-center gap-1 rounded-2xl px-1 py-2 text-[0.6875rem] font-medium leading-none transition-opacity hover:opacity-90"
