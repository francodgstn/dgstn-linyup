    ...
    return (
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger
            render={
              <span className="cursor-help rounded border border-dashed px-1.5 py-0.5 text-xs text-muted-foreground">
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger
          render={
            <span
              className={`cursor-help rounded bg-muted px-1.5 py-0.5 text-xs text-muted-foreground ${
