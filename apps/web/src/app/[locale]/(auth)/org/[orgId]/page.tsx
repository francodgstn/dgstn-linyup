...
/**
 * THE ORGANIZATION'S FRONT DOOR — and it opens onto a different room depending
 * on who knocked.
 *
 * An organizer lands on the dashboard; somebody from a member studio lands on
 ...
 * organization before it could even render a menu item.
 *
 * It waits for the role rather than guessing: sending an organizer to the
