  ...
  return (
    <div className="overflow-hidden rounded-lg border" style={{ borderColor: k.border }}>
      ...
      <div className="space-y-2 p-2.5" style={{ background: palette.background }}>
        <span className="text-[0.625rem] font-semibold uppercase tracking-wide" style={{ color: k.muted }}>
          {label}
        </span>
        ...
        >
          ...
          <span
            className="mt-1 inline-block rounded-md px-2.5 py-1 text-[0.625rem] font-medium"
