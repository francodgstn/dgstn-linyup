              ...
              <div className="relative mb-1 h-5 select-none">
                {drawnTicks.map((tick) => (
                  <div
                    ...
                    className="absolute top-0 text-[0.625rem] leading-5 text-muted-foreground"
                    ...
                    return (
                      ...
                      <HoverCard key={p.id}>
                        <HoverCardTrigger
                          ...
                          render={
                            <button
                              ...
                              className={`group absolute z-20 flex items-center rounded-[4px] text-left text-[0.6875rem] font-medium text-white transition-[filter] hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
                        ...
                        it separates the name from the quantity behind it. */}
                          ...
                          {p.labelSide === 'after' && (
                            <span className="pointer-events-none absolute left-full ml-1.5 whitespace-nowrap text-[0.6875rem] font-medium text-foreground">
                              {event.title}
                            </span>
                          )}
                          {p.labelSide === 'before' && (
                            <span className="pointer-events-none absolute right-full mr-1.5 whitespace-nowrap text-[0.6875rem] font-medium text-foreground">
                              {event.title}
                            </span>
                          )}
                        </HoverCardTrigger>
              ...
              return (
                <li key={b.group}>
                  <button
                    ...
                    className="flex items-baseline gap-1.5 rounded text-[0.6875rem] transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  >
                    <span
                  ...
                  <li key={e.id}>
                    ...
                    >
                      ...
                      {ownerBandsWorth && ownerBandOf(e) === 'org' && (
                        <span className="shrink-0 rounded border px-1 py-px text-[0.625rem] text-muted-foreground">
                          {t('timelineBandOrgRow')}
                        </span>
                      )}
                      ...
                      {isPast && (
                        <span className="flex shrink-0 items-center gap-1 text-[0.6875rem] tabular-nums text-muted-foreground">
