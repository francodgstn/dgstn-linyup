...
export function WaiverChip({
  ...
  return (
    <span
      className={`inline-flex flex-shrink-0 items-center gap-1 rounded-full border px-1.5 py-0.5 text-[0.625rem] font-semibold ${
        shown === 'revoked'
...
export function WaiverDoorCheckChip({
  ...
  return (
    <span
      className="inline-flex flex-shrink-0 items-center gap-1 rounded-full border border-sky-300 px-1.5 py-0.5 text-[0.625rem] font-semibold text-sky-700"
      title={detail}
    >
