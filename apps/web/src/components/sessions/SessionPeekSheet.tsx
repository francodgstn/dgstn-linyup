                  ...
                  <div className="space-y-0.5">
                    {pendingBookings.map((b) => (
                      <div key={b.id} className="flex items-center gap-2.5 py-1.5">
                        <div className="h-7 w-7 rounded-full bg-amber-100 text-amber-700 flex items-center justify-center text-xs font-bold shrink-0">
                ...
                <div className="space-y-0.5">
                  {visibleParticipants.map((p) => (
                    <div key={p.id} className="flex items-center gap-2.5 py-1.5">
                      <div className="h-7 w-7 rounded-full bg-green-100 text-green-700 flex items-center justify-center text-xs font-bold shrink-0">
